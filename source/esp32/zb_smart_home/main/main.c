...
static void lcd_task(void *arg)
{
    ...
    while (1)
    {
        ...
        {
            ESP_LOGI(TAG, "Smartconfig LCD_SCREEN_WIFI_MQTT_INFO");
        ...
        case LCD_SCREEN_DATE_TIME:
            ESP_LOGI(TAG, "Smartconfig LCD_SCREEN_DATE_TIME");
            lcd5110_puts(LCD5110_PIXEL_SET, LCD5110_FONT_SIZE_5x7,
                         "Date & Time");
            lcd5110_goto_xy(0, 12);
        ...
        default:
            ESP_LOGI(TAG, "Smartconfig default");
            break;
        }
